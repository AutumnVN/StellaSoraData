...
function PlayerPotentialPreselectionData:UnPackPotentialData(b64Str)
	...
	if #b64Str % 4 ~= 0 then
		printError("Base64\233\149\191\229\186\166\233\148\153\232\175\175")
		return
	end
	...
	if not ok then
		printError("Base64\232\167\163\231\160\129\229\164\177\232\180\165: " .. tostring(packed_data))
		return
	end
	local bit_buffer = {}
	local bit_count = 0
	...
	for i = 1, 3 do
		...
		if mapCharCfg == nil or mapCharCfg.Visible == false or mapCharCfg.Available == false then
			printError("\232\167\146\232\137\178id\232\167\163\230\158\144\233\148\153\232\175\175")
			return
		end
		...
		for _, nId in ipairs(tbAll) do
			if bSpecial then
				...
				if nLevel > nMaxLevel then
					printError("\230\189\156\232\131\189\231\173\137\231\186\167\229\188\130\229\184\184")
					return false
				end
				if 0 < nLevel then
