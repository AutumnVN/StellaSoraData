...
function GoldenSpyLevelData:RefreshTask()
	...
	if NovaAPI.IsEditorPlatform() then
		print("GoldenSpyLevelCtrl: \229\141\149\228\184\170\231\137\169\229\147\129\228\187\187\229\138\161\230\157\131\233\135\141:", mLogWeight, "\230\128\187\230\157\131\233\135\141:", nRandomTotalWeight)
	end
