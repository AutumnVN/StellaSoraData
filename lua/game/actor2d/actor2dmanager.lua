...
local GetFullSceneAssetPath = function(nCGId, bL2D)
	...
	if nil == cfgData then
		printError(string.format("\232\175\187\229\143\150CharacterCG\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129id = [%s]", nCGId))
	elseif bL2D then
...
local SetL2D = function(sL2D, sOffset, rawImg, nCurPanelId, nReusePanelId, nType, bFull, sBg, tbRenderer)
	...
	if tbRenderer.sL2D == nil then
		...
		if trIns == nil then
			printError("\230\156\170\230\137\190\229\136\176\230\160\185\232\138\130\231\130\185")
		end
...
local GetActor2DParams = function(nPanelId, nCharId, nSkinId, param, nSpecifyType)
	...
	if mapSkinData == nil then
		printError("\230\156\170\230\137\190\229\136\176\232\167\146\232\137\178\231\154\174\232\130\164\230\149\176\230\141\174")
	end
...
function Actor2DManager.SetActor2DInUI(nPanelId, trRoot, nCharId, nSkinId, bLive2D)
	local tbConfig = mapPanelConfig[nPanelId]
	if tbConfig == nil then
		printError("\230\173\164\231\149\140\233\157\162\230\156\170\229\174\154\228\185\137\226\128\156\229\166\130\228\189\149\226\128\157\230\152\190\231\164\1862D\232\167\146\232\137\178\231\171\139\231\187\152, panel id:" .. tostring(nPanelId))
		return
	end
	if nSkinId == nil then
		nSkinId = PlayerData.Char:GetCharSkinId(nCharId)
...
function Actor2DManager.SetActor2D_ForActor2DEditor(nPanelId, rawImg, sSkinId, bFull, sFullPath, s, x, y, bL2D, nL2DX, nL2DY, nL2DS, bNpc)
	...
	if mapCharSkinData == nil then
		printError("\230\156\170\230\137\190\229\136\176\231\154\174\232\130\164\230\149\176\230\141\174")
	end
	...
	if bIsNpc == true then
		...
		if bIsCG == true then
			...
			if mapCGData == nil then
				printError("\230\156\170\230\137\190\229\136\176\232\167\146\232\137\178\231\154\174\232\130\164\231\154\132CG\230\149\176\230\141\174")
			end
...
function Actor2DManager.SetDisc2D(nDiscId, rawImg, bUseL2D, nIndex)
	...
	if nType == 0 then
		print("\230\137\190\228\184\141\229\136\176\230\152\159\231\155\152\232\181\132\230\186\144\239\188\129\239\188\129\239\188\129nDiscId = " .. nDiscId)
		return
	end
...
function Actor2DManager.SetCg2D(nCgId, rawImg, bUseL2D, nIndex)
	...
	if nType == 0 then
		print("\230\137\190\228\184\141\229\136\176CG\232\181\132\230\186\144\239\188\129\239\188\129\239\188\129nCgId = " .. nCgId)
		return
	end
