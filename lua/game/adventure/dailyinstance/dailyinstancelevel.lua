...
function DailyInstanceLevel:OnEvent_LevelResult(tbStar, bAbandon)
	...
	if self.parent:GetSettlementState() then
		printError("\230\151\165\229\184\184\229\137\175\230\156\172\231\187\147\231\174\151\230\181\129\231\168\139\233\135\141\229\164\141\232\191\155\229\133\165\239\188\140\230\156\172\230\172\161\233\128\128\229\135\186")
		return
	end
