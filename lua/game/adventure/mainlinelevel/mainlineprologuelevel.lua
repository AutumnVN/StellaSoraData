...
function MainlinePrologueLevel:GetRewardNpc(nNpcId, nNpcUid)
	...
	if tbSelectPerks[self.curNpcRewardIdx] == nil then
		printError(string.format("\230\178\161\230\156\137\231\172\172%d\228\184\170\229\165\150\229\138\177", self.curNpcRewardIdx))
		return
	end
	local tbPerks = {}
...
function MainlinePrologueLevel:GetRewardBox(nBoxId)
	...
	if mapBoxReward[self.nBoxId] == nil then
		printError(string.format("\230\178\161\230\156\137\233\133\141\231\189\174\229\174\157\231\174\177id\228\184\186%d\231\154\132\229\165\150\229\138\177", self.nBoxId))
		return
	end
	local tbPerks = {}
