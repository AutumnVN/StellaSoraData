	...
	local BuildStarTowerAllFloorData = function(nTowerId)
		...
		for nIdx, nStageGroupId in ipairs(tbStage) do
			...
			if nFloorNum == nil then
				nFloorNum = 99
				printError("FloorNum Missing\239\188\154" .. nTowerId .. " " .. nIdx)
			end
...
function StarTowerLevelData:EnterRoom(nCaseId, nRoomType)
	...
	if self.curMapId == nil then
		printError("\232\191\148\229\155\158\229\156\176\229\155\190id\228\184\186\231\169\186\239\188\129")
	end
	self:SetRoguelikeHistoryMapId(self.curMapId)
	...
	local NetCallback = function(_, mapNetData)
		if mapNetData.EnterResp == nil then
			printError("\230\136\191\233\151\180\230\149\176\230\141\174\232\191\148\229\155\158\228\184\186\231\169\186")
			return
		end
...
function StarTowerLevelData:StarTowerFailed(mapChangeInfo, mapBuildInfo, nTime, npcAffinityReward, TowerRewards, NpcInteraction)
	print("\230\148\190\229\188\131\233\129\151\232\191\185")
	local tbRes = {}
	local tbPresents = {}
	local tbOutfit = {}
	local tbItem = {}
...
function StarTowerLevelData:BuildCharacterData(tbCharacterData, tbDiscData)
	...
	for idx, mapChar in ipairs(tbCharacterData) do
		...
		if tbTalent == nil then
			printError("Talent\232\161\168\230\137\190\228\184\141\229\136\176\232\175\165\232\167\146\232\137\178" .. mapChar.Id)
			tbTalent = {}
		end
		local tbActive = {}
...
function StarTowerLevelData:ProcessTowerChangeData(mapChange)
	...
	if mapChange.Infos and next(mapChange.Infos) ~= nil then
		for _, mapNoteInfo in ipairs(mapChange.Infos) do
			print(string.format("\233\159\179\231\172\166\230\149\176\233\135\143\229\143\152\229\140\150\239\188\154%d,%d", mapNoteInfo.Tid, mapNoteInfo.Qty))
...
function StarTowerLevelData.GetActorHp()
	...
	for i = 0, count do
		...
		logStr = logStr .. string.format("EntityID:%d\t\232\167\146\232\137\178Id\239\191\189?%d\t\232\167\146\232\137\178\232\161\128\233\135\143\239\188\154%d\n", tbActorEntity[i], nCharId, hp)
	end
	print(logStr)
