	...
	for _, mapCaseData in ipairs(tbCases) do
		if mapCaseData.BattleCase ~= nil then
			...
			if self.mapCases[self.EnumCase.Battle] ~= nil then
				printError("\230\136\152\230\150\151\228\186\139\228\187\182\233\135\141\229\164\141 \229\143\175\232\131\189\229\175\188\232\135\180\230\136\191\233\151\180\228\186\139\228\187\182\229\164\132\231\144\134\230\151\160\230\179\149\231\187\147\230\157\159")
			end
			...
			if mapEventCfgData ~= nil then
				...
				if mapNpcCfgData ~= nil then
					...
					if self.mapNpc[nNpcId] ~= nil then
						printError("NpcId\233\135\141\229\164\141" .. mapCaseData.SelectOptionsEventCase.EvtId)
					end
					self.mapNpc[nNpcId] = mapCaseData.Id
					safe_call_cs_func(CS.AdventureModuleHelper.SpawnNPC, nNpcId, nSkinId)
					...
					if ConfigTable.GetData("StarTowerEventAction", nActionId) ~= nil then
						...
						printError("\232\175\165\228\186\139\228\187\182\230\178\161\230\156\137\229\175\185\229\186\148\231\154\132action" .. mapCaseData.SelectOptionsEventCase.EvtId)
						mapCaseData.SelectOptionsEventCase.nActionId = 0
					end
				else
					printError("\230\178\161\230\156\137\230\137\190\229\136\176\229\175\185\229\186\148NPC\233\133\141\231\189\174 " .. nNpcId)
				end
			end
...
function BaseRoom:HandleNpc(nNpcId, nNpcUid)
	...
	if nCaseId == nil then
		printError("Npc\230\178\161\230\156\137\229\175\185\229\186\148\228\186\139\228\187\182ID:" .. nNpcId)
		return
	end
	local mapNpcCfgData = ConfigTable.GetData("NPCConfig", nNpcId)
	if mapNpcCfgData == nil then
	...
	elseif mapNpcCfgData.type == GameEnum.npcNewType.Upgrade then
		...
		printError("\229\190\133\229\164\132\231\144\134\228\186\139\228\187\182")
	end
	printError("\230\178\161\230\156\137\230\137\190\229\136\176\229\143\175\228\186\164\228\186\146\231\154\132\228\186\139\228\187\182:" .. nNpcId)
end
...
function BaseRoom:OpenNpcOptionPanel(nCaseId, nNpcConfigId)
	...
	local callback = function(nIdx, nEvtId)
		...
		if mapOptionData ~= nil then
			...
			printError("EventOptions Missing\239\188\154" .. nOptionId)
		end
		if bJump then
			return
		end
...
function BaseRoom:InteractiveStrengthMachine(nCaseId, nNpcConfigId)
	...
	local InteractiveCallback = function(netmsgData)
		if netmsgData.StrengthenMachineResp ~= nil and not netmsgData.StrengthenMachineResp.BuySucceed then
			...
			printError("\230\178\161\230\156\137\229\143\175\233\128\137\231\154\132\230\189\156\232\131\189")
			return
		end
		if bFirstFree then
