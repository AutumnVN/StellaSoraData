...
function BattleRoom:OnEvent_LevelStateChanged(nState)
	if self.bFailed then
		printError("\232\167\146\232\137\178\229\183\178\230\173\187\228\186\161")
		return
	end
	...
	if self.mapCases[self.EnumCase.Battle] == nil then
		printError("\230\151\160\230\136\152\230\150\151\228\186\139\228\187\182\233\156\128\232\166\129\229\164\132\231\144\134")
		return
	end
...
function BattleRoom:OnEvent_ActorFinishDie()
	if self.bBattleEnd then
		...
		local callback = function(msgData)
			self.nCoinTemp = 0
			self.mapCases[self.EnumCase.Battle].bFinish = true
			print("\233\129\151\232\191\185\229\164\177\232\180\165")
