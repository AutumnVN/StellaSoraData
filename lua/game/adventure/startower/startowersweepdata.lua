	...
	local BuildStarTowerAllFloorData = function(nTowerId)
		...
		for nIdx, nStageGroupId in ipairs(tbStage) do
			...
			if nFloorNum == nil then
				nFloorNum = 99
				printError("FloorNum Missing\239\191\189\239\191\189" .. nTowerId .. " " .. nIdx)
			end
...
function StarTowerSweepData:BuildCharacterData(tbCharacterData, tbDiscData)
	...
	for idx, mapChar in ipairs(tbCharacterData) do
		...
		if tbTalent == nil then
			printError("Talent\239\191\189\239\191\189\239\191\189\210\178\239\191\189\239\191\189\239\191\189\239\191\189\195\189\239\191\189\201\171" .. mapChar.Id)
			tbTalent = {}
		end
		local tbActive = {}
	...
	for _, mapCaseData in ipairs(tbCases) do
		if mapCaseData.BattleCase ~= nil then
			...
			if self.mapCases[self.EnumCase.Battle] ~= nil then
				printError("\213\189\239\191\189\239\191\189\239\191\189\194\188\239\191\189\239\191\189\216\184\239\191\189 \239\191\189\239\191\189\239\191\189\220\181\239\191\189\239\191\189\194\183\239\191\189\239\191\189\239\191\189\239\191\189\194\188\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\222\183\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189")
			end
			...
			if mapEventCfgData ~= nil then
				...
				if mapNpcCfgData ~= nil then
					...
					if self.mapNpc[nNpcId] ~= nil then
						printError("NpcId\239\191\189\216\184\239\191\189" .. mapCaseData.SelectOptionsEventCase.EvtId)
					end
					self.mapNpc[nNpcId] = mapCaseData.Id
					...
					if ConfigTable.GetData("StarTowerEventAction", nActionId) ~= nil then
						...
						printError("\239\191\189\239\191\189\239\191\189\194\188\239\191\189\195\187\239\191\189\208\182\239\191\189\211\166\239\191\189\239\191\189action" .. mapCaseData.SelectOptionsEventCase.EvtId)
						mapCaseData.SelectOptionsEventCase.nActionId = 0
					end
				else
					printError("\195\187\239\191\189\239\191\189\239\191\189\210\181\239\191\189\239\191\189\239\191\189\211\166NPC\239\191\189\239\191\189\239\191\189\239\191\189 " .. nNpcId)
				end
			end
...
function StarTowerSweepData:EnterRoom(nCaseId, nRoomType)
	...
	local NetCallback = function(_, mapNetData)
		if mapNetData.EnterResp == nil then
			printError("\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\221\183\239\191\189\239\191\189\239\191\189\206\170\239\191\189\239\191\189")
			return
		end
...
function StarTowerSweepData:ProcessTowerChangeData(mapChange)
	...
	if mapChange.Infos and next(mapChange.Infos) ~= nil then
		for _, mapNoteInfo in ipairs(mapChange.Infos) do
			print(string.format("\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\228\187\175\239\191\189\239\191\189%d,%d", mapNoteInfo.Tid, mapNoteInfo.Qty))
...
function StarTowerSweepData:HandleNpc(nNpcId, nNpcUid)
	...
	if nCaseId == nil then
		printError("Npc\195\187\239\191\189\208\182\239\191\189\211\166\239\191\189\194\188\239\191\189ID:" .. nNpcId)
		return
	end
	local mapNpcCfgData = ConfigTable.GetData("NPCConfig", nNpcId)
	if mapNpcCfgData == nil then
	...
	elseif mapNpcCfgData.type == GameEnum.npcNewType.Upgrade then
		...
		printError("\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\194\188\239\191\189")
	end
	printError("\195\187\239\191\189\239\191\189\239\191\189\210\181\239\191\189\239\191\189\201\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\239\191\189\194\188\239\191\189:" .. nNpcId)
end
...
function StarTowerSweepData:OpenNpcOptionPanel(nCaseId, nNpcConfigId)
	...
	local callback = function(nIdx, nEvtId, bClose)
		...
		if mapOptionData ~= nil then
			...
			printError("EventOptions Missing\239\191\189\239\191\189" .. nOptionId)
		end
		if bJump then
			self.mapCases[self.EnumCase.NpcEvent][nCaseId].bFinish = true
			self:HandleCases()
...
function StarTowerSweepData:InteractiveStrengthMachine(nCaseId, nNpcConfigId)
	...
	local InteractiveCallback = function(netmsgData)
		if netmsgData.StrengthenMachineResp ~= nil and not netmsgData.StrengthenMachineResp.BuySucceed then
			...
			printError("\195\187\239\191\189\208\191\239\191\189\209\161\239\191\189\239\191\189\199\177\239\191\189\239\191\189")
			return
		end
		if bFirstFree then
