...
function StoryLevel:OnEvent_SendMsgFinishBattle(LevelResult, FadeTime, sVideoName)
	if self.bSettle == true then
		print("\229\183\178\229\156\168\231\187\147\231\174\151\230\181\129\231\168\139\228\184\173\239\188\129")
		return
	end
	self.bSettle = true
	...
	print("====== \229\189\147\229\137\141\233\128\154\229\133\179\228\184\187\231\186\191\229\133\179\229\141\161ID\239\188\154" .. self.nLevelId .. " ======")
	local events = {
