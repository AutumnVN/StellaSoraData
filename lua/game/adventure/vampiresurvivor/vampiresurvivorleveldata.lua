...
function VampireSurvivorLevelData:AddFateCardEft(nFateCardId)
	...
	if mapFateCardCfgData.ClientEffect ~= 0 then
		...
		if 0 < nRemainCount then
			if self.mapFateCardEftCount[mapFateCardCfgData.ClientEffect] ~= nil then
				...
				if nRemainCount < 1 then
					print("\229\145\189\232\191\144\229\141\161\230\149\136\230\158\156\230\172\161\230\149\176\228\184\1860" .. nFateCardId)
					return
				end
			else
		...
		print("\230\183\187\229\138\160\229\145\189\232\191\144\229\141\161\230\149\136\230\158\156\239\188\154" .. nFateCardId)
	end
end
...
function VampireSurvivorLevelData:RemoveFateCardEft(nFateCardId)
	...
	if mapFateCardCfgData == nil then
		...
		print("\231\167\187\233\153\164\229\145\189\232\191\144\229\141\161\230\149\136\230\158\156\239\188\154" .. nFateCardId)
