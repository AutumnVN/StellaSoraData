...
function PeriodicQuestCtrl:RefreshQuestList()
	...
	if nil == self.tbAllQuestList[self._panel.nSelectGroup] then
		printLog(string.format("\228\187\187\229\138\161\229\136\151\232\161\168\228\184\186\231\169\186\239\188\129\239\188\129\239\188\129actId = %s, group = %s", self.nActId, self._panel.nSelectGroup))
		return
	end
...
function PeriodicQuestCtrl:OnBtnClick_Group(_, nIndex)
	...
	if nil == self.tbAllQuestList[nIndex] or nil == next(self.tbAllQuestList[nIndex]) then
		printError(string.format("\229\189\147\229\137\141\228\187\187\229\138\161\231\187\132\228\184\139\230\178\161\230\156\137\228\187\187\229\138\161!!! \230\180\187\229\138\168id = %d, \228\187\187\229\138\161\231\187\132 = %s", self.nActId, nIndex))
		return
	end
