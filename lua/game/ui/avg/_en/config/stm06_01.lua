return {
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"==A-1==<size=47>==RT====RT====RT==\227\128\128When the noble host was overthrown, the thralls would make their liberator known. As heroes grand, yet the outlander with grace declined, and to the Wilds left their fame behind. Thus Nova's bonds were broken, chains undone, the prosperous Monoliths now shared by everyone.</size>==RT====RT==<size=47><align=\"right\">\226\128\148<i>Chronicles of Ancient Nova</i>, by Anonymous</b></size>",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"However, historical records indicate that those willing to follow you\226\128\148to sacrifice themselves for your sake\226\128\148were once as numerous as the stars.",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"You simply sought to conquer the Monoliths to manage them personally\226\128\148to produce Artifacts more efficiently and bring true prosperity to Nova.",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"By equating you with those monsters, they intended for==RT==future generations to see\226\128\148",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"\226\128\148that the Tyrant as nothing more than an oversized Stellaroid.==RT==A clever way to erase the true legend.",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"We hired elite mercenaries and armies of Trekkers. It took==RT==massive resources just to capture one\226\128\148the Blade of Jade.",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"Yet since your waking, you have secured three Seals in barely four months\226\128\148the 'King,' 'Soldier,' and 'Bishop.' Of these, both the King and the Bishop were known only through vague legend.",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"I've already punished her with a magic seed implanted in her body.==W== The toxins will torment her\226\128\148a fate worse than death\226\128\148until you decide to grant her mercy ... or execution.",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"I offer no defense for that. But please, hear me out...==W== Everything I did, I did for you. Behold\226\128\148",
			""
		}
	},
	{
	...
	},
	{
		...
		param = {
			...
			false,
			"",
			"Your Majesty, you are suffering from amnesia. These delusions\226\128\148that you are a Trekker or a CEO, rather than the Tyrant\226\128\148are merely symptoms of your condition.",
			""
		}
	},
	{
