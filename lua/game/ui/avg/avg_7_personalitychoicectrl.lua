...
function Avg_7_PersonalityChoiceCtrl:SetPersonalityChoice(tbParam)
	...
	if mapCfgData_RolePersonality == nil then
		printError("StoryRolePersonality \232\161\168\228\184\173\230\156\170\230\137\190\229\136\176\228\184\187\232\167\146\230\149\176\230\141\174")
		return -1
	end
	local tbPersonalitys = mapCfgData_RolePersonality.Personalitys
	if type(tbPersonalitys) ~= "table" then
		printError("StoryRolePersonality \232\161\168\228\184\173\228\184\187\232\167\146\230\139\165\230\156\137\231\154\132\228\184\137\228\184\170\230\128\167\230\160\188\230\149\176\230\141\174\230\156\137\232\175\175")
		return -1
	end
	if #tbPersonalitys ~= 3 then
		printError("StoryRolePersonality \232\161\168\228\184\173\228\184\187\232\167\146\231\154\132\230\128\167\230\160\188\230\149\176\233\135\143\228\184\141\228\184\1863")
		return -1
	end
	self._color = {}
	...
	for i = 1, 3 do
		...
		if mapCfgData_Personality == nil then
			printError("StoryPersonality \232\161\168\228\184\173\230\156\170\230\137\190\229\136\176\230\149\176\230\141\174 id:" .. nPID)
			return -1
		end
