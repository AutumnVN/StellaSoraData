...
function AvgPanel:RequireAndPreProcAvgConfig(sAvgConfigPath, sHead, _sGroupId)
	...
	if not ok then
		printError("AVG \230\140\135\228\187\164\233\133\141\231\189\174\230\150\135\228\187\182\230\156\170\230\137\190\229\136\176\239\188\140\232\183\175\229\190\132:" .. sAvgConfigPath .. ". error: " .. aaa)
		EventManager.Hit(EventId.OpenMessageBox, "AVG \230\140\135\228\187\164\233\133\141\231\189\174\230\150\135\228\187\182\230\156\170\230\137\190\229\136\176\239\188\140\232\183\175\229\190\132:" .. sAvgConfigPath)
...
function AvgPanel:OnEvent_AvgSpeedUp(nRate)
	printLog("Avg\229\138\160\233\128\159 AvgPanel " .. nRate)
...
function AvgPanel:RUN()
	if type(self.sExecutingCMDName) == "string" then
		printError(string.format("\229\189\147\229\137\141\230\140\135\228\187\164 %s \229\176\154\230\156\170\230\137\167\232\161\140\229\174\140\230\136\144\239\188\140\229\156\168\228\184\128\229\184\167\233\135\140\229\143\136\232\176\131\231\148\168\228\186\134\228\184\128\230\172\161 AvgPanel:RUN() \230\142\165\229\143\163\239\188\140\229\191\133\233\161\187\230\142\146\230\159\165\230\173\164\228\184\165\233\135\141\233\148\153\232\175\175\239\188\129\239\188\129", self.sExecutingCMDName))
		return
	end
	if self.timerWaiting ~= nil then
		self.timerWaiting:Cancel()
	...
	if self.mapProcFunc[sCmd] == nil then
		printError("\230\156\170\230\137\190\229\136\176\232\175\165\230\140\135\228\187\164\239\188\154" .. sCmd)
		return
	end
	...
	self.sExecutingCMDName = nil
	printLog(string.format("\231\180\162\229\188\149:%s\230\140\135\228\187\164:%s\232\128\151\230\151\182:%f", self.nCurIndex or "nil", sCmd, nWaitTime))
