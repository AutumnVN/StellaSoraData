...
function AvgEditorCtrl:PrepareConstCmdParamOptions()
	...
	NovaAPI.SetText(self._mapNode.Placeholder_CurPlayerName, "\231\142\169\229\174\182\229\189\147\229\137\141\229\144\141\229\173\151\228\184\186\239\188\154" .. self._panel.sPlayerNickName)
end
...
function AvgEditorCtrl:RefreshDropdown(sNewAvgId)
	...
	if #self.tbFileName > 0 then
		printLog("\230\188\148\229\135\186\233\133\141\231\189\174\230\150\135\228\187\182\229\144\141\229\136\151\232\161\168\230\156\170\230\184\133\231\169\186")
	end
...
function AvgEditorCtrl:OnBtnClick_AddST(btn)
	...
	if table.indexof(self.tbFileName, sAvgId) > 0 then
		local msg = "\233\135\141\229\144\141\228\186\134\239\188\140\232\175\183\230\163\128\230\159\165\230\140\135\228\187\164\233\133\141\231\189\174\230\150\135\228\187\182\231\155\174\229\189\149\227\128\130"
	...
	if sFileNameHead ~= "ST" and sFileNameHead ~= "BT" and sFileNameHead ~= "CG" and sFileNameHead ~= "BB" and sFileNameHead ~= "GD" then
		local msg = "\233\156\128\228\187\165 ST \230\136\150 BT \230\136\150 CG \230\136\150 BB \229\188\128\229\164\180\239\188\140\232\175\183\233\152\133\232\175\187\230\163\128\230\159\165\229\145\189\229\144\141\232\167\132\229\136\153\227\128\130"
		if self._panel.nCurLanguageIdx ~= 0 then
...
function AvgEditorCtrl:OnBtnClick_SetPlayerName(btn)
	...
	if sName ~= "" then
		...
		NovaAPI.SetText(self._mapNode.Placeholder_CurPlayerName, "\231\142\169\229\174\182\229\189\147\229\137\141\229\144\141\229\173\151\228\184\186\239\188\154" .. sName)
	end
end
...
function AvgEditorCtrl:OnBtnClick_Output(btn)
	...
	local sOutput = "{--[[\229\185\133\229\186\166]]{%s,%s,%s},--[[\229\145\168\230\156\159]]{%s,%s,%s},--[[\230\172\161\230\149\176]]{%s,%s,%s},--[[\229\143\140\229\144\145]]{%s,%s,%s},--[[\232\161\176\229\135\143]]{%s,%s,%s}},{--[[\229\185\133\229\186\166]]{%s,%s,%s},--[[\229\145\168\230\156\159]]{%s,%s,%s},--[[\230\172\161\230\149\176]]{%s,%s,%s},--[[\229\143\140\229\144\145]]{%s,%s,%s},--[[\232\161\176\229\135\143]]{%s,%s,%s}},--[[\229\190\170\231\142\175]]%s"
...
function AvgEditorCtrl:OnBtnClick_ConfirmGroupId()
	...
	if sGroupId == "" then
		if self.sPreviewHead == "BB" or self.sPreviewHead == "DP" then
			...
			local msg = "\232\175\183\232\190\147\229\133\165\231\187\132ID"
			if self._panel.nCurLanguageIdx ~= 0 then
...
function AvgEditorCtrl:OnValueChanged(go)
	...
	if n == nil then
		if go == nil then
			printError("\229\136\183\230\150\176\230\140\135\228\187\164\230\160\188\229\173\144\233\148\153\232\175\175\239\188\129\239\188\129")
		end
		printError(go.name)
		return
	end
...
function AvgEditorCtrl:SetNoteAbsolutePos(tr, sName, nPivotX, nPivotY, nPosX, nPosY)
	nPivotX = nPivotX or "\228\184\141\229\143\152"
	nPivotY = nPivotY or "\228\184\141\229\143\152"
	nPosX = nPosX or "\228\184\141\229\143\152"
	nPosY = nPosY or "\228\184\141\229\143\152"
