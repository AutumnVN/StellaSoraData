...
function BattleDashboardCtrl:OnEvent_ShowHand(nInteractiveId, bShowUI, sIcon, sText, nDuration)
	...
	printLog("\228\186\164\228\186\146id" .. tostring(nInteractiveId))
	...
	for i = 1, 2 do
		...
		if nSupportCharId ~= 0 and nSupportPlayerId ~= 0 then
			...
			if skilldata ~= nil then
				...
				printError("Skill \232\161\168\228\184\173\239\188\140\232\175\165\230\138\128\232\131\189 id \230\156\170\230\137\190\229\136\176\239\188\154" .. tostring(nSkillId))
			end
...
function BattleDashboardCtrl:OnBtn_ClickHand(btn)
	...
	printLog("\229\143\145\233\128\129\230\151\182\228\186\164\228\186\146id" .. tostring(self.nInteractiveId))
