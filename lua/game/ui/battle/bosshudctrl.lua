...
function BossHUDCtrl:OpenUI(bossId, nDataId, nType, nBloodType, bRefresh)
	if self.bossId ~= 0 and self.bossId ~= nil and bReinit then
		printError(string.format("boss\232\161\128\230\157\161\229\183\178\232\162\171EntityId\228\184\186%d\231\187\145\229\174\154 %d\233\135\141\229\164\141\231\187\145\229\174\154\228\184\141\231\148\159\230\149\136", self.bossId, bossId))
		return
	end
