...
function BossSkillHintIndicator:SetTarget(nEntityId, nBossSkinId, bHold, fRecycleCallback)
	if self.nEntityId ~= nil then
		printError("\233\135\141\229\164\141\231\187\145\229\174\154")
		return
	end
...
function BossSkillHintIndicator:OnEvent_SkillHint()
	if self.endTimer ~= nil then
		printError("\229\183\178\229\156\168\230\138\128\232\131\189\231\187\147\230\157\159\229\164\132\231\144\134\228\184\173")
		return
	end
