...
function SubSkillDisplayCtrl:OnEvent_Init(tbTeam)
	self.mapChar = {}
	if #tbTeam < 3 then
		printWarn("\228\186\186\230\149\176\229\176\143\228\186\1423")
		return
	end
	for i = 2, 3 do
...
function SubSkillDisplayCtrl:SkillDisplay(nCharId, nSkillId)
	...
	if mapData.nSkillShowIdx == 0 then
		...
		printError("\230\178\161\230\156\137\230\167\189\228\189\141\230\146\173\230\148\190\230\138\128\232\131\189\229\177\149\231\164\186")
	else
