...
function ReceiveSpecialRewardCtrl:ShowReward()
	...
	if self.bCG then
		...
		if charCGCfg == nil then
			printError(string.format("\232\175\187\229\143\150CharacterCG\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129id = [%s]", curReward.nId))
		else
			self:ShowCharCG()
		end
...
function ReceiveSpecialRewardCtrl:ShowCGTitle()
	...
	if mapCGCgfData == nil then
		printError(string.format("\232\175\187\229\143\150CharacterCG\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129id = [%s]", self.nId))
	else
...
function ReceiveSpecialRewardCtrl:ShowItem(tbRewardItem)
	if tbRewardItem ~= nil and 0 < #tbRewardItem then
		...
		if mapRewardItemCfgData == nil then
			printError("item ID missing\239\188\154" .. tbRewardItem[1].Tid)
			...
			NovaAPI.SetTMPText(self._mapNode.TMP_ItemCount, string.format("\195\151%d", tostring(nRewardItemCount)))
		end
	else
		self._mapNode.rtItemTips:SetActive(false)
	end
