		...
		if mapItemCfgData.Stype == GameEnum.itemStype.EnergyItem or mapItemCfgData.Stype == GameEnum.itemStype.SouvenirEnergyItem then
			...
			for itemId, count in pairs(useCfg) do
				...
				if nil ~= checkItemCfg and checkItemCfg.Stype == GameEnum.itemStype.Energy then
					...
					printLog(string.format("\228\189\147\229\138\155\233\129\147\229\133\183\228\189\191\231\148\168\229\143\130\230\149\176\233\133\141\231\189\174\233\148\153\232\175\175\239\188\129\239\188\129\239\188\129\232\175\183\230\163\128\230\159\165\239\188\129itemId = [%s]", itemId))
				end
			end
			local mapItem = {
