...
function FRIndicators:OnEvent_SetIndicator(nType, rtTransform, v3Offset, sIconPath)
	if #self.tbIndicators > 10 then
		printError("\231\174\177\229\173\144\228\188\160\233\128\129\233\151\168\230\140\135\231\164\186\229\153\168\230\149\176\233\135\143\228\184\138\233\153\144")
		return
	end
	if nType == 1 then
...
function FRIndicators:OnEvent_SetIndicatorEnemy(nEntityId, v3Offset)
	if #self.tbEnemyIndicators > 10 then
		printError("\230\149\140\228\186\186\230\140\135\231\164\186\229\153\168\230\149\176\233\135\143\228\184\138\233\153\144")
		return
	end
