...
function FormationCtrl:LoadCharacter(nCharId, bOpen)
	...
	if not mapSkin then
		printLog("\230\178\161\230\156\137\230\137\190\229\136\176\231\154\174\232\130\164\233\133\141\231\189\174" .. nCharId)
		return
	end
...
function FormationCtrl:OnBtnClick_FastFormation(btn)
	local confirmCallback = function()
		...
		elseif self.nFRType == AllEnum.FormationEnterType.StarTower then
			...
			printError("\228\184\141\229\134\141\230\148\175\230\140\129\232\128\129\233\129\151\232\191\185\232\183\179\232\189\172")
		end
...
function FormationCtrl:OnBtnClick_Start(btn)
	...
	elseif self.nFRType == AllEnum.FormationEnterType.FixedRoguelike then
		printError("\228\184\141\229\134\141\230\148\175\230\140\129\232\191\155\229\133\165\232\128\129\233\129\151\232\191\185")
	elseif self.nFRType == AllEnum.FormationEnterType.StarTower then
		self:EnterStarTower()
	end
