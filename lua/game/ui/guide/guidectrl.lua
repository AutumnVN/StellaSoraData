...
function GuideCtrl:DoCurrentStepGuide()
	...
	if gGroupData == nil then
		traceback("\230\151\160\230\149\136\231\154\132\229\188\149\229\175\188\231\187\132id" .. tostring(PlayerData.Guide.runGroupId))
		return
	end
...
function GuideCtrl:PlayTypeMask(msg)
	...
	if objTemp == nil then
		...
		printError("\230\178\161\230\156\137\230\137\190\230\137\147\229\188\149\229\175\188\231\154\132\229\155\190\230\160\135 === " .. msg.BindIcon)
		return
	else
