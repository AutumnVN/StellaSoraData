...
function BuffCtrl:OnEvent_BuffUI(nUid, nBuffId, nTime, nCount)
	...
	if nTime == 0 or nCount == 0 then
		if self.mapBuff[nUid] == nil then
			print("0\230\151\182\233\151\180\230\136\150\229\177\130\230\149\176buff \228\184\141\229\164\132\231\144\134")
			return
		else
		...
		if self.nActiveCount > 40 then
			printError("buff\230\149\176\233\135\143\232\191\135\229\164\154\230\156\172\230\172\161\228\184\141\229\164\132\231\144\134")
			return
		end
		if self.mapBuff[nUid] == nil then
...
function BuffCtrl:BindEntity(nEntityId)
	if self.nEntityId ~= nil then
		printError(string.format("buff\229\183\178\232\162\171\231\187\145\229\174\154 \229\189\147\229\137\141:%d,\231\187\145\229\174\154:%d", self.nEntityId, nEntityId))
		return
	end
