...
function InfinityTowerPauseCtrl:ShowPanelMonsterList(nPreviewMonsterGroupId)
	...
	for _, v in ipairs(self.tbMonster) do
		...
		if nil == monsterCfg then
			printError("\232\175\187\229\143\150PreviewMonsterList\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129monsterId = " .. v.PreviewMonsterListId)
			bOpen = false
		end
	end
	if not bOpen then
