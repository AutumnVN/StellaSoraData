...
function LoginCtrl:RequestIke()
	...
	NovaAPI.ResetIke()
	if #self.serverInfoList <= 0 then
		printError("\230\178\161\230\156\137\229\140\186\230\156\141\230\149\176\230\141\174")
		self.bOnLogin = false
		return
	end
	if not self.selectServerIndex then
		printError("\230\178\161\230\156\137\233\128\137\230\139\169\229\140\186\230\156\141")
		self.bOnLogin = false
		return
	end
	local msgSend = {}
