...
function MainlineMonsterInfoCtrl:ShowPanel(nPreviewMonsterGroupId, tbOverrideWeakEET)
	...
	local wait = function()
		...
		if tbMonsterGroup == nil then
			printError("\232\142\183\229\143\150PreviewMonsterGroup\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129PreviewMonsterGroupId = " .. nPreviewMonsterGroupId)
			return
		end
		...
		for _, v in ipairs(self.tbMonster) do
			...
			if nil == monsterCfg then
				printError("\232\175\187\229\143\150Monster\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129monsterId = " .. v)
				bOpen = false
			end
		end
		if not bOpen then
...
function MainlineMonsterInfoCtrl:RefreshMonsterGrid(goGrid, gridIndex)
	...
	if nil == mData then
		printError("\232\175\187\229\143\150Monster\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129monsterId = " .. nMonsterId)
		return
	end
	local mSkin = ConfigTable.GetData("MonsterSkin", mData.FAId)
	if nil == mSkin then
		printError("\232\175\187\229\143\150MonsterSkin\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129skinId = " .. mData.FAId)
		return
	end
	local mManual = ConfigTable.GetData("MonsterManual", mSkin.MonsterManual)
	if nil == mManual then
		printError("\232\175\187\229\143\150MonsterSkin\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129MonsterManualId = " .. mSkin.MonsterManual)
		return
	end
...
function MainlineMonsterInfoCtrl:RefreshMonsterInfo(nMonsterId)
	...
	if nil == monsterData then
		printError(string.format("Monster\230\149\176\230\141\174\228\184\186\231\169\186\239\188\129\239\188\129\239\188\129id = [%s]", nMonsterId))
		return
	end
	local monsterSkin = ConfigTable.GetData("MonsterSkin", monsterData.FAId)
	if nil == monsterSkin then
		printError(string.format("MonsterSkin\230\149\176\230\141\174\228\184\186\231\169\186\239\188\129\239\188\129\239\188\129id = [%s]", monsterData.FAId))
		return
	end
	local monsterAdjust = ConfigTable.GetData("MonsterValueTempleteAdjust", monsterData.Templete)
	if nil == monsterAdjust then
		printError(string.format("MonsterValueTempleteAdjust\230\149\176\230\141\174\228\184\186\231\169\186\239\188\129\239\188\129\239\188\129id = [%s]", monsterData.Templete))
		return
	end
	local monsterManual = ConfigTable.GetData("MonsterManual", monsterSkin.MonsterManual)
	if nil == monsterManual then
		printError(string.format("MonsterManual\230\149\176\230\141\174\228\184\186\231\169\186\239\188\129\239\188\129\239\188\129id = [%s]", monsterSkin.MonsterManual))
		return
	end
