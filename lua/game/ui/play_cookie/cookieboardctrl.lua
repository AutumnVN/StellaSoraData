...
function CookieBoardCtrl:NoteCheck()
	...
	printLog("\229\136\164\229\174\154\239\188\154\229\189\147\229\137\141\233\159\179\231\172\166\230\151\182\233\151\180\229\183\174\228\184\186 " .. nRes .. "\n\232\138\130\230\139\141\229\153\168\230\151\182\233\151\180\239\188\154" .. self.nBeatsTimer .. "\n\230\151\182\233\146\159\230\151\182\233\151\180\239\188\154" .. self.nFixedTimer)
	...
	elseif nRes < self.nGoodThreshold and nRes > -self.nGoodThreshold then
		...
		printLog("\229\136\164\229\174\154\239\188\154Miss \230\178\161\230\156\137FC\228\186\134")
		return
	end
...
function CookieBoardCtrl:NotePerfect()
	printLog("\229\136\164\229\174\154\239\188\154Perfect Critical")
...
function CookieBoardCtrl:NoteGood()
	printLog("\229\136\164\229\174\154\239\188\154Good \228\189\160\230\156\137\228\184\128\228\184\170\229\165\189")
	...
	if self.bRhythmMode then
		...
		if nNoteMissTime < self.nFixedTimer and self.bMissSwitch then
			if not self.bCurrNoteClicked then
				printLog("\229\136\164\229\174\154\239\188\154Miss\239\188\140\230\151\160\230\147\141\228\189\156\229\175\188\232\135\180\231\154\132")
				self:NoteMiss()
				self:PlayHitEffect(GameEnum.CookieRhythmlResult.Miss)
			end
			self.bMissSwitch = false
