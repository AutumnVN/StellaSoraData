...
function SettingsKeyboardCtrl:LoadSetting()
	...
	for _, v in ipairs(self._panel.Action) do
		...
		if bHas then
			if tbControl.Count ~= 3 then
				printError("input config\230\149\176\233\135\143\228\184\141\228\184\1863\239\188\140\231\188\186\229\164\177\233\133\141\231\189\174")
				return
			end
	...
	if bHorizontal then
		if tbHorizontal.Count ~= 7 then
			printError("input config\230\149\176\233\135\143\228\184\141\228\184\1867\239\188\140\231\188\186\229\164\177\233\133\141\231\189\174")
			return
		end
