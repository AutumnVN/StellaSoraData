...
function NoteCardItemCtrl:SetNoteCardItem(nId, tbNote, tbShowNote)
	...
	if nil == noteCfg then
		printError(string.format("\232\142\183\229\143\150\233\159\179\231\172\166\230\142\137\232\144\189\232\161\168\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129id = [%s]", nId))
		return
	end
