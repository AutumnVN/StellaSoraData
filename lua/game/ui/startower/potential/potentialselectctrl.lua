...
function PotentialSelectCtrl:Refresh(nEventId, tbPotential, mapPotential, nType, nLevel, tbNewIds, mapRoll, nCoin, tbLuckyIds, bAfterRoll, tbRecommend)
	...
	if tbPotential == nil or #tbPotential == 0 then
		...
		traceback("\230\189\156\232\131\189\229\141\161\233\128\137\230\139\169\229\136\151\232\161\168\228\184\186\231\169\186\239\188\129\239\188\129\239\188\129")
		return
	end
...
function PotentialSelectCtrl:PlayCharVoice(tbPotential)
	...
	for k, v in ipairs(tbPotential) do
		...
		if nil == potentialCfg then
			printError(string.format("\232\142\183\229\143\150\230\189\156\232\131\189\232\161\168\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129id = [%s])", nId))
			return
		end
