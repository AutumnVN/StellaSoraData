...
function StarTowerRoomInfo:FateCardChange(mapFateCard)
	...
	for _, v in ipairs(mapFateCard) do
		...
		if v[4] == -1 then
			...
			nFailureId = nId
			printLog("\231\167\187\233\153\164\229\145\189\232\191\144\229\141\161" .. nId)
		elseif v[4] == 0 then
			self.mapFateCard[nId] = {
				v[2],
				v[3]
			}
			printLog(string.format("\229\145\189\232\191\144\229\141\161\229\177\130\230\149\176\229\143\152\229\140\150  id = [%s]  \229\177\130\230\149\176[%s]", nId, math.max(v[2], v[3])))
		elseif v[4] == 1 then
			printLog("\230\150\176\232\142\183\229\190\151\229\145\189\232\191\144\229\141\161" .. nId)
			self.mapFateCard[nId] = {
				v[2],
				v[3]
			}
...
function StarTowerRoomInfo:OnEvent_OpenBossTime(nStage, nType, callback)
	...
	if CacheTable.GetData("_StarTowerLimitReward", nStarTowerId) == nil then
		printError("StarTowerLimitReward\232\161\168\228\184\173\230\137\190\228\184\141\229\136\176\230\152\159\229\161\148\233\133\141\231\189\174\239\188\129\239\188\129\239\188\129\230\152\159\229\161\148id = " .. tostring(nStarTowerId))
		return
	elseif CacheTable.GetData("_StarTowerLimitReward", nStarTowerId)[nStage] == nil then
		printError("StarTowerLimitReward\232\161\168\228\184\173\230\137\190\228\184\141\229\136\176\230\152\159\229\161\148stage\233\133\141\231\189\174!!!  stage = " .. tostring(nStage))
		return
	end
