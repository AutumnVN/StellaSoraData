...
function DepotFateCardCtrl:RefreshFateCard(mapFateCard)
	...
	for nId, v in pairs(mapFateCard) do
		...
		if 5 < nBundleIdx or nBundleIdx < 1 then
			printError("\230\151\160\230\179\149\232\142\183\229\143\150Bundle\231\180\162\229\188\149")
			nBundleIdx = 1
		end
...
function DepotFateCardCtrl:SetFateCardInfo(nIdx)
	...
	if nil ~= mapSelect then
		...
		if nil == fateCardCfg then
			printError(string.format("\232\142\183\229\143\150FateCard\232\161\168\230\160\188\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129id = [%s]", mapSelect.nTid))
			return
		end
