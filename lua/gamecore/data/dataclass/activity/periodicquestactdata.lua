...
function PeriodicQuestActData:GetCurOpenDay()
	...
	if nil == nMaxDay then
		printError("\232\175\187\229\143\150PeriodicQuestGroup\233\133\141\231\189\174\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129actId = " .. tostring(self.nActId))
		return 1
	end
