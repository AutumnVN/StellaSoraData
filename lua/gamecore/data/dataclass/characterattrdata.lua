...
function CharacterAttrData:ParseConfig(mapCustom)
	...
	if not attrConfig then
		printError("\232\167\146\232\137\178\232\161\168\229\177\158\230\128\167id\233\133\141\231\189\174\228\184\141\229\175\185\239\188\140\232\167\146\232\137\178" .. self.nId)
		return
	end
	local skillConfig = ConfigTable.GetData_Skill(config.UltimateId)
	if not skillConfig then
		printError("\232\167\146\232\137\178Skill\232\161\168\229\164\167\230\139\155\230\178\161\233\133\141" .. config.UltimateId)
		return
	end
	for _, v in pairs(self.CharAttrList) do
