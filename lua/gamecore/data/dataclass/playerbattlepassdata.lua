...
function PlayerBattlePassData:CacheBattlePassInfo(mapData)
	...
	print("\229\189\147\229\137\141\232\181\155\229\173\163ID\239\188\154" .. mapData.Id)
...
function PlayerBattlePassData:GetBattlePassInfo(callback)
	local GetMsgCallback = function()
		if not self.hasData then
			printError("\230\156\170\232\142\183\229\143\150\229\136\176\230\136\152\228\187\164\230\149\176\230\141\174")
			return
		end
		local mapRet = {}
		local mapReward = {}
