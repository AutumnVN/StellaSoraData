...
function PlayerBuildData:CreateBuildBriefData(mapBuildBriefMsg)
	if nil ~= self._MapBuildData[mapBuildBriefMsg.Id] then
		printLog(string.format("\231\188\150\233\152\159\228\191\161\230\129\175\233\135\141\229\164\141\239\188\129\239\188\129\239\188\129id= [%s]", mapBuildBriefMsg.Id))
	end
	local mapBuildData = {
...
function PlayerBuildData:CreateBuildDetailData(nBuildId, mapBuildDetailMsg)
	...
	if nil == self._MapBuildData[nBuildId] then
		printLog(string.format("\230\137\190\228\184\141\229\136\176\231\188\150\233\152\159\228\191\161\230\129\175\239\188\129\239\188\129\239\188\129id= [%s]", nBuildId))
		return
	end
...
function PlayerBuildData:GetBuildDetailData(callback, nBuildId)
	if self._MapBuildData[nBuildId] == nil then
		if self.hasData then
			printWarn("\230\178\161\230\156\137\232\175\165id\231\154\132build\239\188\140\229\164\167\230\166\130\231\142\135\229\183\178\232\162\171\229\136\134\232\167\163\239\188\154" .. nBuildId)
			if callback then
				callback()
			end
			return false
...
function PlayerBuildData:GetBuildAllEft(nBuildId)
	...
	if mapBuildData == nil or not mapBuildData.bDetail then
		print("\230\178\161\230\156\137\229\175\185\229\186\148build \230\136\150\230\156\170\232\142\183\229\143\150\232\175\165build\232\175\166\231\187\134\230\149\176\230\141\174")
		return ret
	end
	local mapCharEffect = {}
...
function PlayerBuildData:CreateTrialBuild(nTrialId)
	...
	if mapTrialData == nil then
		printError("\232\175\149\231\148\168\231\188\150\231\187\132\230\149\176\230\141\174\230\178\161\230\156\137\230\137\190\229\136\176\239\188\154" .. nTrialId)
		return
	end
	self._mapTrialBuild = {
		nBuildId = nTrialId,
...
function PlayerBuildData:GetTrialBuildAllEft()
	...
	for nCharId, tbPerk in pairs(mapBuildData.tbPotentials) do
		if tbCharIdToTrial[nCharId] then
			...
			printError("\228\189\147\233\170\140build\229\134\133\239\188\140\230\156\137\229\164\154\228\189\153\232\167\146\232\137\178\231\154\132\230\189\156\232\131\189" .. nCharId)
		end
	end
	local mapDiscEffect = {}
