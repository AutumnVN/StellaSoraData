...
function PlayerCharData:GetCharSkillAddedLevel(nCharId)
	...
	if mapChar == nil then
		printError("\230\178\161\230\156\137\232\175\165\232\167\146\232\137\178\230\149\176\230\141\174" .. nCharId)
		mapChar = {
			nLevel = 1,
			nAdvance = 0,
			tbSkillLvs = {
...
function PlayerCharData:GetTrialCharSkillAddedLevel(nTrialId)
	...
	if mapChar == nil then
		printError("\230\178\161\230\156\137\232\175\165\232\167\146\232\137\178\230\149\176\230\141\174" .. nTrialId)
		return {
			1,
			1,
			1,
...
function PlayerCharData:GetNewChar(mapData)
	...
	local func_ForEach_InsertNewChar = function(ChangeInfo)
		...
		if self._mapChar[charID] ~= nil then
			printLog("\232\142\183\229\143\150\233\135\141\229\164\141\232\167\146\232\137\178:" .. charID)
			return
		end
	...
	for _, nTrialId in ipairs(tbTrialId) do
		if 0 < nTrialId then
			...
			if mapTrialData == nil then
				printError("\228\189\147\233\170\140\232\167\146\232\137\178\230\149\176\230\141\174\230\178\161\230\156\137\230\137\190\229\136\176\239\188\154" .. nTrialId)
				return
			end
...
function PlayerCharData:GetTrialCharById(nTrialId)
	...
	if mapTrialChar == nil then
		printError("\230\178\161\230\156\137\232\175\165\232\175\149\231\148\168\232\167\146\232\137\178\230\149\176\230\141\174:" .. nTrialId)
	end
	return mapTrialChar
end
...
function PlayerCharData:GetCharCfgAttr(tbPropertyIndexList, nCharId, nAdvance, nLevel)
	...
	if type(mapAttribute) == "table" then
		...
		printError("\232\167\146\232\137\178\229\177\158\230\128\167\233\133\141\231\189\174\233\148\153\232\175\175\239\188\154" .. nAttrBaseId)
		for i = 1, #tbPropertyIndexList do
			local nindex = tbPropertyIndexList[i]
			local mapCharAttr = AllEnum.CharAttr[nindex]
			mapAttr[mapCharAttr.sKey] = {
...
function PlayerCharData:GetDataForCharList()
	...
	for nCharId, data in pairs(self._mapChar) do
		...
		if mapCfg ~= nil then
			...
			printError(nCharId .. "\232\167\146\232\137\178\230\149\176\230\141\174\228\184\141\229\173\152\229\156\168")
		end
	end
	return mapChar
end
...
function PlayerCharData:CalCharacterAttrBattle(nCharId, stAttr, bMainChar, tbDiscId, nBuildId)
	...
	if mapCharAttrCfg == nil then
		printError("\229\177\158\230\128\167\233\133\141\231\189\174\228\184\141\229\173\152\229\156\168:" .. nAttrId)
		return {}
	end
	local mapCharCfg = ConfigTable.GetData_Character(nCharId)
	if mapCharCfg == nil then
		printError("\232\167\146\232\137\178\233\133\141\231\189\174\228\184\141\229\173\152\229\156\168:" .. nCharId)
		return {}
	end
	...
	if tbDiscId ~= nil then
		for _, nDiscId in ipairs(tbDiscId) do
			...
			if mapDisc and mapDisc.mapAttrBase then
				...
				printError("\230\152\159\231\155\152\230\149\176\230\141\174\230\156\137\232\175\175id:" .. nDiscId)
			end
		end
	end
	local mapBuildAttr = {}
		...
		for nAttrValueId, v in pairs(tbRandomAttr) do
			...
			if mapAttrCfg then
				...
				if bAttrFix then
					...
					if mapAttr == nil then
						printError(string.format("\227\128\144\232\163\133\229\164\135\233\154\143\230\156\186\229\177\158\230\128\167\227\128\145lua\229\177\158\230\128\167\233\133\141\231\189\174\228\184\173\230\178\161\230\137\190\229\136\176\229\175\185\229\186\148\233\133\141\231\189\174!!! attrId = %s", nAttrValueId))
					else
