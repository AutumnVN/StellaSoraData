	...
	for _, mapTab in pairs(tbData) do
		for _, mapEntry in pairs(mapTab.Entries) do
			...
			if nId then
				...
				printError("DictionaryEntry\232\161\168\229\143\152\230\155\180\239\188\140TabId" .. mapTab.TabId .. ";Index" .. mapEntry.Index .. "\229\175\185\229\186\148\231\154\132\232\175\141\230\157\161\230\156\170\230\137\190\229\136\176")
			end
		end
	end
end
