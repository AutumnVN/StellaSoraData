...
function PlayerDiscData:SendDiscStrengthenReq(nId, tbMat, callback)
	if self._mapDisc[nId] == nil then
		printError(string.format("\230\152\159\231\155\152\228\184\141\229\173\152\229\156\168, id\228\184\186: %d", nId))
		return
	end
	local tbItems = {}
	for _, mapMat in pairs(tbMat) do
...
function PlayerDiscData:CreateNewDisc(tbData)
	...
	for _, mapDisc in ipairs(tbData) do
		if self._mapDisc[mapDisc.Id] == nil then
			...
			printError(string.format("\230\152\159\231\155\152\229\148\175\228\184\128Id\233\135\141\229\164\141, \229\148\175\228\184\128Id: %d", mapDisc.Id))
		end
	end
end
function PlayerDiscData:UpdateDiscData(nId, mapData)
	if self._mapDisc[nId] == nil then
		printLog(string.format("\232\175\165\230\152\159\231\155\152\228\184\141\229\173\152\229\156\168/\230\152\175\230\150\176\230\152\159\231\155\152, \229\148\175\228\184\128Id: %d", nId))
...
function PlayerDiscData:CreateTrialDisc(tbTrialId)
	...
	for _, nTrialId in ipairs(tbTrialId) do
		...
		if mapCfg == nil then
			printError("\228\189\147\233\170\140\230\152\159\231\155\152\230\149\176\230\141\174\230\178\161\230\156\137\230\137\190\229\136\176\239\188\154" .. nTrialId)
			return
		end
