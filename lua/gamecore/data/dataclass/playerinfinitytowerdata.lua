...
function PlayerInfinityTowerData:EnterInfinityTower(lvId, buildId, isContinue)
	...
	if lvData == nil then
		printError("\230\151\160\229\176\189\229\161\148floorData \228\184\186\231\169\186,lvData id === " .. lvId)
		return
	end
	local floorData = ConfigTable.GetData("InfinityTowerFloor", lvData.FloorId)
	if floorData == nil then
		printError("\230\151\160\229\176\189\229\161\148floorData \228\184\186\231\169\186,floor id === " .. lvData.FloorId)
		return
	end
...
function PlayerInfinityTowerData:EnterInfinityTowerEditor(floorId, tbChar, tbDisc, tbNote)
	...
	if floorData == nil then
		printError("\230\151\160\229\176\189\229\161\148floorData \228\184\186\231\169\186,floor id === " .. floorId)
		return
	end
