...
function PlayerMainlineDataEx:GetAllLevelByChapter(nChapterId)
	if self._mainlineData[nChapterId] == nil then
		printError("\230\178\161\230\156\137\231\171\160\232\138\130\230\149\176\230\141\174\239\188\154" .. nChapterId)
		return {}
	end
	local tbId = {}
	local mapId = {}
	...
	local function AddMainline(nId)
		...
		if levelData == nil then
			printError("\229\133\179\229\141\161\230\149\176\230\141\174\228\184\141\229\173\152\229\156\168" .. nId)
			return
		end
...
function PlayerMainlineDataEx:EnterTest(nMainlineId, nTeamId)
	if self._mainlineLevel ~= nil then
		printError("\229\189\147\229\137\141\229\133\179\229\141\161level\228\184\141\228\184\186\231\169\1862")
		return
	end
...
function PlayerMainlineDataEx:NetMsg_EnterMainline(nMainlineId, nTeamIdx, callback)
	if self._mainlineLevel ~= nil then
		printError("\229\189\147\229\137\141\229\133\179\229\141\161level\228\184\141\228\184\186\231\169\1863")
		return
	end
	local msgCallback = function(_, mapMsgData)
		if callback ~= nil then
		...
		local mapMainline = ConfigTable.GetData_Mainline(nMainlineId)
		if mapMainline == nil then
			printError("\228\184\187\231\186\191\230\149\176\230\141\174\228\184\141\229\173\152\229\156\168\239\188\154" .. nMainlineId)
			return
		end
