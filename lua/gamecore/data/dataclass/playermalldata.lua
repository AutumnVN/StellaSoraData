...
function PlayerMallData:OnEvent_PayRespone(nCode, sMsg, nOrderId, sExData)
	...
	printLog("\230\148\182\229\136\176SDK PayRespone")
...
function PlayerMallData:CollectDequeue()
	...
	printLog("\229\189\147\229\137\141\229\164\132\231\144\134\232\174\162\229\141\149\239\188\154" .. mapOrder.nOrderId)
	if next(self._tbOrderCollect) ~= nil then
		printLog("----\233\162\132\229\164\135\232\174\162\229\141\149----")
		for _, v in ipairs(self._tbOrderCollect) do
			printLog("\232\174\162\229\141\149\239\188\154" .. v.nOrderId .. "    \231\173\137\229\190\133\229\164\132\231\144\134")
		end
		printLog("---------------")
	else
		printLog("\229\144\142\231\187\173\230\151\160\229\190\133\229\164\132\231\144\134\232\174\162\229\141\149")
	end
...
function PlayerMallData:CollectOrder(mapOrder, mapData, tbSpReward)
	printLog("\232\174\162\229\141\149\239\188\154" .. mapOrder.nOrderId .. "    \229\165\150\229\138\177\231\138\182\230\128\129\239\188\154" .. mapData.Status)
	...
	if mapData.Status == OrderStatus.Unpaid or mapData.Status == OrderStatus.Retry then
		...
		for _, v in pairs(self._tbWaitingOrderCollect) do
			if v.nOrderId == mapOrder.nOrderId then
				bHasWait = true
				printError("\232\174\162\229\141\149\239\188\154" .. mapOrder.nOrderId .. "    \233\135\141\229\164\141\232\191\155\229\133\165\231\173\137\229\190\133\229\136\151\232\161\168")
				break
			end
		end
	...
	local funcClear = function()
		...
		if self._bWaitTimeOut then
			...
			for _, mapOrder in pairs(self._tbWaitingOrderCollect) do
				printError("\232\174\162\229\141\149\239\188\154" .. mapOrder.nOrderId .. "    \232\182\133\230\151\182\232\174\162\229\141\149\239\188\140\233\156\128\232\166\129\232\129\148\231\179\187\229\174\162\230\156\141\239\188\140\228\184\141\229\134\141\232\175\183\230\177\130")
			end
		else
			printLog("----\233\156\128\233\135\141\230\150\176\232\175\183\230\177\130\231\154\132\232\174\162\229\141\149----")
			for _, mapOrder in pairs(self._tbWaitingOrderCollect) do
				table.insert(self._tbOrderCollect, mapOrder)
				printLog("\232\174\162\229\141\149\239\188\154" .. mapOrder.nOrderId .. "    \230\156\170\230\136\144\229\138\159\239\188\140\233\135\141\230\150\176\232\191\155\229\133\165\232\174\162\229\141\149\229\136\151\232\161\168")
			end
			printLog("---------------")
		end
		self._tbWaitingOrderCollect = {}
...
function PlayerMallData:SendBattlePassOrderReq(nMode, nVersion, callback)
	...
	local successCallback = function(_, mapData)
		printLog("\229\136\155\229\187\186\232\174\162\229\141\149\239\188\154" .. mapData.Id)
		callback(mapData)
	end
...
function PlayerMallData:SendMallOrderCancelReq(nId, nCode, callback)
	...
	printLog("\232\174\162\229\141\149\229\143\150\230\182\136")
	EventManager.Hit(EventId.OpenMessageBox, {
		nType = AllEnum.MessageBox.Alert,
...
function PlayerMallData:SendMallPackageOrderReq(sId, callback)
	...
	local successCallback = function(_, mapData)
		if mapData.Order then
			printLog("\229\136\155\229\187\186\232\174\162\229\141\149\239\188\154" .. mapData.Order.Id)
