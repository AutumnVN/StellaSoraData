...
function PlayerPhoneData:GetChatHistoryList(nAddressId)
	...
	if nil ~= self.tbAddressBook[nAddressId] then
		...
		printError(string.format("\232\142\183\229\143\150\232\129\138\229\164\169\228\191\161\230\129\175\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129addressId = [%s]", nAddressId))
	end
...
function PlayerPhoneData:GetChatData(nAddressId, nChatId)
	...
	traceback(string.format("\232\142\183\229\143\150\232\129\138\229\164\169\228\191\161\230\129\175\229\164\177\232\180\165\239\188\129\239\188\129\239\188\129addressId = [%s], chatId = [%s]", nAddressId, nChatId))
end
...
function PlayerPhoneData:CheckChatComplete(nChatId)
	...
	printError(string.format("\232\129\138\229\164\169\230\156\170\232\167\163\233\148\129\239\188\140\232\175\183\230\163\128\230\159\165\233\133\141\231\189\174\239\188\129\239\188\129chatId = [%s])", nChatId))
	return true
end
...
function PlayerPhoneData:GetAVGPhoneMsg(nChatId, sLanguage)
	...
	if nil ~= chatCfg then
		...
		if nil == self.tbChatMsgCache[sAvgCfgPath] then
			...
			if not ok then
				printError("AvgId\229\175\185\229\186\148\231\154\132\233\133\141\231\189\174\230\150\135\228\187\182\230\178\161\230\156\137\230\137\190\229\136\176\239\188\140path\239\188\154" .. sAvgCfgPath .. ". error: " .. tbAllAvgCfg)
				return
			else
