...
function PlayerRoguelikeData.GetActorHp()
	...
	for i = 0, count do
		...
		logStr = logStr .. string.format("EntityID:%d\t\232\167\146\232\137\178Id\239\188\154%d\t\232\167\146\232\137\178\232\161\128\233\135\143\239\188\154%d\n", tbActorEntity[i], nCharId, hp)
	end
	print(logStr)
...
function PlayerRoguelikeData:SettleCallback(mapData)
	...
	if mapData.NextFloor == nil then
		print("\233\129\151\232\191\185\230\156\128\231\187\136\229\177\130\231\187\147\231\174\151\231\187\147\230\157\159")
		self:UpdatePassedId(self.curRoguelikeId)
		print("\232\174\176\229\189\149\233\128\154\232\191\135id")
		self:RoguelikeClear(mapData)
		print("\229\188\185\229\135\186\231\187\147\231\174\151\231\170\151\229\143\163")
		return
	end
	...
	if type(self.curFloorProcess.SettleCallback) == "function" then
		...
		printError("\229\189\147\229\137\141\230\181\129\231\168\139\230\151\160\229\175\185\229\186\148\229\164\132\231\144\134\230\150\185\230\179\149\239\188\154" .. "SettleCallback")
	end
end
...
function PlayerRoguelikeData:FloorEnd()
	if self.nextFloorProcess ~= nil then
		...
		printError("\228\184\139\229\177\130\229\164\132\231\144\134\230\181\129\231\168\139\230\156\170\232\174\190\231\189\174")
	end
...
function PlayerRoguelikeData:AddToRoguelikeBag(nTid, nCount)
	if ConfigTable.GetData_Item(nTid) == nil then
		print("\230\151\160\229\175\185\229\186\148tid\230\149\176\230\141\174\239\188\154" .. nTid)
		return
	end
...
function PlayerRoguelikeData:OnEvent_LevelStateChanged(LevelResult)
	...
	if type(self.curFloorProcess.OnTouchPortal) == "function" then
		...
		printError("\229\189\147\229\137\141\230\181\129\231\168\139\230\151\160\229\175\185\229\186\148\229\164\132\231\144\134\230\150\185\230\179\149\239\188\154" .. "OnTouchPortal")
	end
end
function PlayerRoguelikeData:OnEvent_OnRoguelikeEnter()
	if type(self.curFloorProcess.OnRoguelikeEnter) == "function" then
		...
		printError("\229\189\147\229\137\141\230\181\129\231\168\139\230\151\160\229\175\185\229\186\148\229\164\132\231\144\134\230\150\185\230\179\149\239\188\154" .. "OnRoguelikeEnter")
	end
end
	...
	if PlayerData.nCurGameType == AllEnum.WorldMapNodeType.Roguelike then
		...
		elseif nType == GameEnum.monsterEpicType.LORD then
			if PlayerRoguelikeData.bKillBoss then
				printError("\233\135\141\229\164\141\229\135\187\230\157\128boss")
			...
			if type(self.curFloorProcess.OnBossDied) == "function" then
				...
				printError("\229\189\147\229\137\141\230\181\129\231\168\139\230\151\160\229\175\185\229\186\148\229\164\132\231\144\134\230\150\185\230\179\149\239\188\154" .. "OnBossDied")
			end
		end
	end
end
function PlayerRoguelikeData:OnEvent_OpenChest(nIndex, bIsRandom, nType)
	...
	if bIsRandom then
		if self._mapRandomChest[nType] == nil then
			print("\230\151\160\229\175\185\229\186\148\229\174\157\231\174\177\231\177\187\229\158\139\239\188\154" .. nType)
			return
		end
		if self._mapRandomChest[nType][nIndex] == nil then
			print("\230\151\160\229\175\185\229\186\148\229\174\157\231\174\177\230\149\176\230\141\174\239\188\154" .. nType .. " " .. nIndex)
			return
		end
	...
	if mapChestLocal == nil then
		print("\230\151\160\229\175\185\229\186\148\229\174\157\231\174\177\230\149\176\230\141\174\239\188\154" .. mapChest.Tid)
		return
	end
	local callback = function()
	...
	print("\229\174\157\231\174\177\231\180\162\229\188\149\239\188\154" .. nIndex .. " \229\174\157\231\174\177\229\186\143\229\136\151\239\188\154" .. self.tbOpenedChest[1])
end
function PlayerRoguelikeData:OnEvent_AbandonRoguelike(bFailed)
	if type(self.curFloorProcess.OnAbandon) == "function" then
		...
		printError("\229\189\147\229\137\141\230\181\129\231\168\139\230\151\160\229\175\185\229\186\148\229\164\132\231\144\134\230\150\185\230\179\149\239\188\154" .. "OnAbandon")
	end
end
...
function PlayerRoguelikeData:OnEvent_SelectPerk(nIndex, selectPerks)
	...
	print("\233\128\137\230\139\169\231\167\152\229\174\157\231\154\132\229\174\157\231\174\177\231\180\162\229\188\149\239\188\154" .. nIndex)
end
