...
function PlayerScoreBossData:CacheScoreBossInstanceData(mapMsgData, openPanelCallBack)
	...
	for i, v in pairs(mapMsgData.Levels) do
		if self.tabScoreBossLevel[v.LevelId] then
			...
			printError("ScoreBossControl \228\184\139\229\143\145\230\149\176\230\141\174\229\146\140\233\133\141\231\189\174\230\149\176\230\141\174\229\175\185\228\184\141\228\184\138")
		end
	end
