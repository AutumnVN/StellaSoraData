...
function PlayerStateData:CheckState()
	if self.mapStarTowerState.BuildId ~= 0 then
		print("\230\173\163\229\156\168\228\191\157\229\173\152\231\154\132BuildId" .. self.mapStarTowerState.BuildId)
...
function PlayerStateData:CheckStarTowerState()
	...
	if bState then
		print(string.format("\230\173\163\229\156\168\232\191\155\232\161\140\231\154\132\233\129\151\232\191\185:%s", self.mapStarTowerState.Id))
