...
function PlayerTalentData:CreateNewTalentData(nCharId, tbActive)
	...
	if not tbGroupCfg then
		printError("TalentGroup\232\161\168\230\137\190\228\184\141\229\136\176\232\175\165\232\167\146\232\137\178" .. nCharId)
		tbGroupCfg = {}
	end
...
function PlayerTalentData:CreateEnhancedSkill(nCharId, tbTalentId)
	...
	if not charCfgData then
		printError("Character\232\161\168\230\137\190\228\184\141\229\136\176\232\175\165\232\167\146\232\137\178" .. nCharId)
		return {}
	end
	local mapSkill = {
...
function PlayerTalentData:CacheTalentData(mapMsgData, nTalentResetTime)
	...
	for _, mapCharInfo in ipairs(mapMsgData) do
		...
		if tbTalent == nil then
			printError("Talent\232\161\168\230\137\190\228\184\141\229\136\176\232\175\165\232\167\146\232\137\178" .. nCharId)
			tbTalent = {}
		end
		local tbActive = {}
