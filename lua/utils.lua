...
function decodeJson(sJson)
	...
	if type(sJson) == "string" and sJson ~= "" then
		...
		if tbData == nil then
			tbData = {}
			printError("json\230\150\135\230\156\172\233\133\141\231\189\174\230\160\188\229\188\143\230\156\137\232\175\175\239\188\140\232\175\165\230\150\135\230\156\172\228\184\186\239\188\154" .. sJson)
		end
	end
	return tbData
end
...
local DecodeChangeInfo = function(mapChangeInfo)
	...
	for nIndex, mapGoogleProtobufAny in ipairs(mapChangeInfo.Props) do
		if mapGoogleProtobufAny.type_url == "" or mapGoogleProtobufAny.type_url == nil then
			printError("ChangeInfo \230\160\188\229\188\143\233\148\153\232\175\175")
			return mapDecodedChangeInfo
		end
...
local strLengthConfig = {
	...
	},
	{
		...
		sType = "\229\133\168\232\167\146\231\172\166\229\143\183",
		nCount = 2
	}
}
...
local SubDesc = function(str, nLevel, nCompareLevel, mapLinkParam)
	...
	local SubDescLink = function(originStr, mapParam)
		...
		for word in string.gmatch(originStr, "##.-#%d%d%d%d#") do
			if mapWord[word] == nil then
				...
				if nWordId == nil then
					printError("\232\175\141\230\157\161 id \233\148\153\232\175\175:" .. sWordId)
					mapWord[word] = sWordId
				else
					local mapWordData = ConfigTable.GetData("Word", nWordId)
					if mapWordData == nil or mapWordData.Icon == "" then
						printError("\232\175\165\232\175\141\230\157\161 id \230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:" .. sWordId)
						if mapWordData and mapWordData.Icon == "" then
							printError("\232\175\165\232\175\141\230\157\161 id \230\137\190\228\184\141\229\136\176Icon:" .. sWordId)
						end
					...
					elseif mapWordData.Type == GameEnum.wordLinkType.Potential then
						if mapParam == nil or mapParam.nCharId == nil then
							printError("\232\175\165<\230\189\156\232\131\189>\232\175\141\230\157\161 id \230\137\190\228\184\141\229\136\176\232\167\146\232\137\178:" .. sWordId)
							mapWord[word] = string.format("<color=#FF0000>%s</color>", sWordId)
						else
	...
	local ParseHitDamageDesc = function(nHitDamageId, nHitDamageLevel)
		...
		if not mapDamage then
			return string.format("<color=#BD3059>\232\175\165 hit damage id \230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", nHitDamageId)
		end
		...
		if not nPercent or not nAbs then
			return string.format("<color=#BD3059>\232\175\165\230\138\128\232\131\189\231\173\137\231\186\167\229\156\168 HitDamage \232\161\168\228\184\173\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174, hit damage id:%d, level:%d</color>", nHitDamageId, nHitDamageLevel)
		end
	...
	local ParseEffectDesc = function(nEffectId, nEffectLevel, nShowType)
		...
		if mapEffectCfgData == nil then
			return string.format("<color=#BD3059>\232\175\165EffectId\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", nEffectId)
		end
		...
		if mapEffectValueData == nil then
			return string.format("<color=#BD3059>\232\175\165EffectId\229\146\140\231\173\137\231\186\167\230\137\190\228\184\141\229\136\176Value\230\149\176\230\141\174:%s\239\188\140%s</color>", nEffectId, nEffectLevel)
		end
		local sValue = mapEffectValueData.EffectTypeParam1
		local nValue = tonumber(sValue)
		if nValue == nil then
			return string.format("<color=#BD3059>\232\175\165EffectValueId\233\133\141\231\189\174\231\154\132\230\149\176\230\141\174\228\184\141\230\148\175\230\140\129\230\152\190\231\164\186:%s</color>", nValueKey)
		end
	...
	local ParseOnceDesc = function(nOnceId, nOnceLevel, nShowType)
		...
		if mapCfgData == nil then
			return string.format("<color=#BD3059>\232\175\165OnceAdditionalAttributeId\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", nOnceId)
		end
		...
		if mapValueData == nil then
			return string.format("<color=#BD3059>\232\175\165OnceAdditionalAttributeId\229\146\140\231\173\137\231\186\167\230\137\190\228\184\141\229\136\176Value\230\149\176\230\141\174:%s\239\188\140%s\239\188\140%s</color>", nOnceId, nOnceLevel, nValueKey)
		end
	...
	local ParseShieldDesc = function(nShieldId, nShieldLevel, nShowType)
		...
		if mapCfgData == nil then
			return string.format("<color=#BD3059>\232\175\165ShieldId\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", nShieldId)
		end
		...
		if mapValueData == nil then
			return string.format("<color=#BD3059>\232\175\165ShieldId\229\146\140\231\173\137\231\186\167\230\137\190\228\184\141\229\136\176Value\230\149\176\230\141\174:%s\239\188\140%s</color>", nShieldId, nShieldLevel)
		end
	...
	local ParseSriptDesc = function(nSriptId, nSriptLevel, nShowType)
		...
		if mapCfgData == nil then
			return string.format("<color=#BD3059>\232\175\165SriptId\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", nSriptId)
		end
		...
		if mapValueData == nil then
			return string.format("<color=#BD3059>\232\175\165SriptId\229\146\140\231\173\137\231\186\167\230\137\190\228\184\141\229\136\176Value\230\149\176\230\141\174:%s\239\188\140%s</color>", nSriptId, nSriptLevel)
		end
	...
	for word in string.gmatch(linkStr, "&.-&") do
		...
		if sTable == nil or sKey == nil then
			mapWord[word] = string.format("<color=#BD3059>\233\133\141\231\189\174\233\148\153\232\175\175\239\188\140\230\151\160\230\179\149\232\175\187\229\143\150\229\175\185\229\186\148\232\161\168\229\144\141\229\146\140ID\239\188\154%s</color>", word)
		else
			local nKey = tonumber(sKey)
			if nKey == nil then
				mapWord[word] = string.format("<color=#BD3059>\232\161\168ID\233\133\141\231\189\174\233\148\153\232\175\175\239\188\140\230\151\160\230\179\149\232\189\172\228\184\186number\239\188\154%s</color>", word)
			...
			elseif sTable == "Script" then
				...
				mapWord[word] = string.format("<color=#BD3059>\230\156\170\230\148\175\230\140\129\231\154\132\232\161\168\229\144\141\239\188\154%s</color>", word)
			end
		end
	end
	for word, finalStr in pairs(mapWord) do
...
local ParseDesc = function(mapDescConfig, nCompareLevelType, nCompareLevel, bSimple, nOverrideLevel, mapLinkParam)
	if mapDescConfig == nil then
		printError("\232\167\163\230\158\144\230\143\143\232\191\176\229\164\177\232\180\165!")
		return ""
	end
	local ConfigData = require("GameCore.Data.ConfigData")
	...
	local ParseHitDamageDesc = function(nHitDamageId, nHitDamageLevel)
		...
		local mapDamage = ConfigTable.GetData_HitDamage(nHitDamageId)
		if not mapDamage then
			sDesc = string.format("<color=#BD3059>\232\175\165 hit damage id \230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", nHitDamageId)
			return sDesc
		end
		...
		local nAbs = mapDamage.SkillAbsAmend[nHitDamageLevel]
		if not nPercent or not nAbs then
			sDesc = string.format("<color=#BD3059>\232\175\165\230\138\128\232\131\189\231\173\137\231\186\167\229\156\168 HitDamage \232\161\168\228\184\173\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174, hit damage id:%d, level:%d</color>", nHitDamageId, nHitDamageLevel)
			return sDesc
		end
		nPercent = nPercent * ConfigData.IntFloatPrecision
		nPercent = FormatNum(nPercent)
				...
				if tbEnum ~= nil then
					...
					if nEnumValue ~= nil then
						if tbEnum[nEnumValue] then
							...
							printError(sEnumType .. "\230\158\154\228\184\190\230\156\170\230\137\190\229\136\176\229\128\188:" .. nEnumValue)
							return nil
						end
					else
						printError("\230\158\154\228\184\190\229\128\188\229\161\171\229\134\153\233\148\153\232\175\175:" .. sValue)
						return nil
					end
				else
					printError("\230\158\154\228\184\190\231\177\187\229\158\139\229\161\171\229\134\153\233\148\153\232\175\175:" .. sEnumType)
					return nil
				end
			else
				printError("\230\158\154\228\184\190\231\177\187\229\158\139\230\156\170\229\161\171\229\134\153")
				return nil
			end
		else
			local nValue = tonumber(sValue)
	...
	local ParseLevelUpDesc = function(sTable, nId, nLevel, sParameter, sShowType, sEnumType)
				...
				if mapData ~= nil then
					...
					if mapValueData ~= nil then
						...
						if sValue ~= nil then
							...
							if sDesc == nil then
								sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\232\175\165ValueId\233\133\141\231\189\174\231\154\132\230\149\176\230\141\174\232\167\163\230\158\144\229\164\177\232\180\165:%s</color>", sValueTable, nValueId)
							end
						else
							sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\230\178\161\230\156\137\232\175\165\229\173\151\230\174\181:%s</color>", sValueTable, sParameter)
						end
					else
						sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\232\175\165Id\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", sValueTable, nValueId)
					end
				else
					sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\232\175\165Id\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", sTable, nId)
				end
			else
				sErrorInfo = string.format("<color=#BD3059>\230\137\190\228\184\141\229\136\176\232\175\165\233\133\141\231\189\174\232\161\168:%s</color>", sValueTable)
			end
		else
			sErrorInfo = string.format("<color=#BD3059>\230\137\190\228\184\141\229\136\176\232\175\165\233\133\141\231\189\174\232\161\168:%s</color>", sTable)
		end
		...
		if sDesc == nil then
			printError("\230\143\143\232\191\176\232\167\163\230\158\144\229\164\177\232\180\165")
			sDesc = ""
		end
		return sDesc
	end
		...
		if mapCfgData ~= nil then
			...
			if mapData ~= nil then
				...
				if sValue ~= nil then
					sDesc = FormatValueShow(sValue, sShowType, sEnumType)
					if sDesc == nil then
						sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\232\175\165Id\233\133\141\231\189\174\231\154\132\230\149\176\230\141\174\232\167\163\230\158\144\229\164\177\232\180\165:%s</color>", sTable, nId)
					end
				else
					sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\230\178\161\230\156\137\232\175\165\229\173\151\230\174\181:%s</color>", sTable, sParameter)
				end
			else
				sErrorInfo = string.format("<color=#BD3059>%s\232\161\168\228\184\173\232\175\165Id\230\137\190\228\184\141\229\136\176\230\149\176\230\141\174:%s</color>", sTable, nId)
			end
	...
	for word in string.gmatch(linkStr, "&.-&") do
		...
		if sTable == nil or sKey == nil then
			...
			if mapCfgData ~= nil then
				...
				mapWord[word] = string.format("<color=#BD3059>\230\137\190\228\184\141\229\136\176\232\175\165\233\133\141\231\189\174\232\161\168:%s</color>", sTable)
			end
		end
	end
	for word, finalStr in pairs(mapWord) do
		...
		if mapWord[word] == nil then
			...
			if nWordId == nil then
				...
				elseif mapSkillNext and mapSkill[fieldName] ~= mapSkillNext[fieldName] then
					mapWord[word] = mapSkill[fieldName] .. "<color=#8cac59>(" .. mapSkillNext[fieldName] .. "\226\134\145)</color>"
				else
					mapWord[word] = mapSkill[fieldName]
				end
				if not mapWord[word] then
					mapWord[word] = "{\230\156\170\230\137\190\229\136\176\229\143\130\230\149\176\233\133\141\231\189\174}"
				end
		...
		if mapWord[word] == nil then
			...
			if nWordId == nil then
				...
				if mapCfgNext and mapCfg[fieldName] ~= mapCfgNext[fieldName] then
					mapWord[word] = mapCfg[fieldName] .. "<color=#8cac59>(" .. mapCfgNext[fieldName] .. "\226\134\145)</color>"
				elseif sColor then
...
local ParseRewardItemCount = function(tbReward)
	...
	if #tbReward < 3 then
		printError("\231\137\169\229\147\129\230\149\176\233\135\143\233\133\141\231\189\174\233\148\153\232\175\175\239\188\140\229\186\148\230\156\137\232\135\179\229\176\1453\228\184\170\229\143\130\230\149\176")
		return -1
	end
	if #tbReward == 3 then
		return tbReward[2]
...
local AddEffect = function(nCharId, nEffectId, nLevel, nUseCount)
	...
	if mapEftValueData.TakeEffectLimit ~= 0 then
		...
		if nEftRemainTimes <= 0 then
			printLog("\230\149\136\230\158\156\230\172\161\230\149\176\229\183\178\231\148\168\229\174\140:" .. nEffectId)
			return nil
		end
	end
...
local ClickWordLink = function(link, sWordId, mapLinkParam)
	...
	if mapWordData == nil then
		if sWordId == nil then
			printError("sWordId\228\184\186\231\169\186")
			return
		end
		printError("wordId error:" .. sWordId)
		return
